...
Para colaboração com o repositório, deve-se consultar as Issues do 
repositório de desenvolvimento https://github.com/eduardocesar93/FGV-Goal. 
Abaixo segue um passo a passo para executar o sistema localmente. 

- Possui interpretador Python https://www.python.org/ e um editor de texto.

- Recomenda-se estudar a documentação do Flask http://flask.pocoo.org/, que 
é a microframework utilizada junto ao python.
